namespace NextGenSoftware.Holochain.HoloNET.Client
{
    ...
    /// from Holochain 0.7.0. In 0.5.x and earlier, request_timeout_s lived directly on
    /// ConductorConfig; in 0.7.0 it moved under ConductorConfig.network (NetworkConfig).
