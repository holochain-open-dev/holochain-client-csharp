...
//        public delegate void CollectionUpdated(object sender, ZomeFunctionCallBackEventArgs e);

//        /// <summary>
//        /// Fired after the UpdateCollection method has finished loading the Holochain Collection from the Holochain Conductor. This calls the CallZomeFunction on the HoloNET client passing in the zome function name specified in the constructor param `zomeUpdateCollectionFunction` or property `ZomeUpdateCollectionFunction` and then maps the data returned from the zome call onto your collection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
//        /// </summary>
...
//                HoloNETClient.HoloNETDNA = holoNETConfig;
...
//        public HoloNETEntryBaseClass(string zomeName, string zomeLoadEntryFunction, string zomeCreateEntryFunction, string zomeUpdateEntryFunction, string zomeDeleteEntryFunction, ILogger logger, string ZomeLoadCollectionFunction = "", string ZomeAddToCollectionFunction = "", string ZomeUpdateCollectionFunction = "", string ZomeRemoveFromCollectionFunction = "", bool alsoUseDefaultLogger = false, bool autoCallInitialize = true,  HoloNETDNA holoNETConfig = null, ConnectedCallBackMode connectedCallBackMode = ConnectedCallBackMode.WaitForHolochainConductorToConnect, RetrieveAgentPubKeyAndDnaHashMode retrieveAgentPubKeyAndDnaHashMode = RetrieveAgentPubKeyAndDnaHashMode.Wait, bool retrieveAgentPubKeyAndDnaHashFromConductor = true, bool retrieveAgentPubKeyAndDnaHashFromSandbox = true, bool automaticallyAttemptToRetrieveFromConductorIfSandBoxFails = true, bool automaticallyAttemptToRetrieveFromSandBoxIfConductorFails = true, bool updateConfigWithAgentPubKeyAndDnaHashOnceRetrieved = true)
//        {
//            //HoloNETClient = new HoloNETClient(logger, alsoUseDefaultLogger, holochainConductorURI);
//            HoloNETClient = new HoloNETClient(logger, alsoUseDefaultLogger;
//            _disposeOfHoloNETClient = true;
...
//            HoloNETClient = new HoloNETClient(logger, alsoUseDefaultLogger, logToConsole, logToFile, releativePathToLogFolder, logFileName, addAdditionalSpaceAfterEachLogEntry, showColouredLogs, debugColour, infoColour, warningColour, errorColour);
//            _disposeOfHoloNETClient = true;
...
//            HoloNETClient = new HoloNETClient(loggers, alsoUseDefaultLogger);
//            _disposeOfHoloNETClient = true;
...
//            HoloNETClient = new HoloNETClient(loggers, alsoUseDefaultLogger, logToConsole, logToFile, releativePathToLogFolder, logFileName, addAdditionalSpaceAfterEachLogEntry, showColouredLogs, debugColour, infoColour, warningColour, errorColour);
//            _disposeOfHoloNETClient = true;
...
//        /// <param name="automaticallyAttemptToRetrieveFromSandBoxIfConductorFails">If this is set to true it will automatically attempt to get the AgentPubKey & DnaHash from the HC Sandbox command if it fails to get them from the Holochain Conductor. This defaults to true.</param>
//        /// <param name="updateConfigWithAgentPubKeyAndDnaHashOnceRetrieved">Set this to true (default) to automatically update the HoloNETConfig once it has retrieved the DnaHash & AgentPubKey.</param>
//        public HoloNETEntryBaseClass(string zomeName, string zomeLoadEntryFunction, string zomeCreateEntryFunction, string zomeUpdateEntryFunction, string zomeDeleteEntryFunction, HoloNETDNA holoNETConfig, string ZomeLoadCollectionFunction = "", string ZomeAddToCollectionFunction = "", string ZomeUpdateCollectionFunction = "", string ZomeRemoveFromCollectionFunction = "", bool autoCallInitialize = true, ConnectedCallBackMode connectedCallBackMode = ConnectedCallBackMode.WaitForHolochainConductorToConnect, RetrieveAgentPubKeyAndDnaHashMode retrieveAgentPubKeyAndDnaHashMode = RetrieveAgentPubKeyAndDnaHashMode.Wait, bool retrieveAgentPubKeyAndDnaHashFromConductor = true, bool retrieveAgentPubKeyAndDnaHashFromSandbox = true, bool automaticallyAttemptToRetrieveFromConductorIfSandBoxFails = true, bool automaticallyAttemptToRetrieveFromSandBoxIfConductorFails = true, bool updateConfigWithAgentPubKeyAndDnaHashOnceRetrieved = true)
//        {
...
//        /// <returns></returns>
//        public virtual async Task<ZomeFunctionCallBackEventArgs> UpdateCollectionAsync(string collectionAnchor, bool useReflectionToMapKeyValuePairResponseOntoEntryDataObject = true)
//        {
//            try
//            {
//                if (!IsInitialized && !IsInitializing)
...
//                ZomeFunctionCallBackEventArgs result = await HoloNETClient.CallZomeFunctionAsync(ZomeName, ZomeUpdateCollectionFunction, collectionAnchor);
//                ProcessZomeReturnCall(result);
//                OnLoaded?.Invoke(this, result);
//                return result;
//            }
...
//        /// <param name="collectionAnchor">The anchor of the Holochain Collection you wish to update.</param>
//        /// <returns></returns>
//        public virtual ZomeFunctionCallBackEventArgs UpdateCollection(string collectionAnchor, bool useReflectionToMapKeyValuePairResponseOntoEntryDataObject = true)
//        {
//            return LoadCollectionAsync(collectionAnchor).Result;
//        }
//        */
