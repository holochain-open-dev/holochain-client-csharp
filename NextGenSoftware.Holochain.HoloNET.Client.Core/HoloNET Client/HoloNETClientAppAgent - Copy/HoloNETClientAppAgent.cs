...
//{
//    public partial class HoloNETClientAppAgent : HoloNETClientBase, IHoloNETClientAppAgent
//    {
...
//        public HoloNETClientAppAgent(string installedAppId, HoloNETDNA holoNETDNA = null) : base(holoNETDNA)
//        {
//            //if (holoNETDNA == null)
...
//        /// <param name="holoNETDNA">The HoloNETDNA you wish to use for this connection (optional). If this is not passed in then it will use the default HoloNETDNA defined in the HoloNETDNA property.</param>
//        public HoloNETClientAppAgent(string installedAppId, ILogProvider logProvider, bool alsoUseDefaultLogger = false, HoloNETDNA holoNETDNA = null) : base(logProvider, alsoUseDefaultLogger, holoNETDNA)
//        {
//            //if (holoNETDNA == null)
//            //    HoloNETDNA = new HoloNETDNA() { AutoStartHolochainConductor = false, AutoShutdownHolochainConductor = false };
...
//        /// <param name="holoNETDNA">The HoloNETDNA you wish to use for this connection (optional). If this is not passed in then it will use the default HoloNETDNA defined in the HoloNETDNA property.</param>
//        public HoloNETClientAppAgent(string installedAppId, IEnumerable<ILogProvider> logProviders, bool alsoUseDefaultLogger = false, HoloNETDNA holoNETDNA = null) : base(logProviders, alsoUseDefaultLogger, holoNETDNA)
//        {
//            //if (holoNETDNA == null)
//            //    HoloNETDNA = new HoloNETDNA() { AutoStartHolochainConductor = false, AutoShutdownHolochainConductor = false };
//            //else
...
//        /// <param name="holoNETDNA">The HoloNETDNA you wish to use for this connection (optional). If this is not passed in then it will use the default HoloNETDNA defined in the HoloNETDNA property.</param>
//        public HoloNETClientAppAgent(string installedAppId, Logger logger, HoloNETDNA holoNETDNA = null) : base(logger, holoNETDNA)
//        {
//            //if (holoNETDNA == null)
//            //   HoloNETDNA = new HoloNETDNA() { AutoStartHolochainConductor = false, AutoShutdownHolochainConductor = false };
