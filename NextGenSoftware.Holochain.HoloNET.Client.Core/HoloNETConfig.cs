...
namespace NextGenSoftware.Holochain.HoloNET.Client.Core
{
    public class HoloNETConfig
    {
        ...
        public string AgentPubKey { get; set; } = "hCAk3R-gBvP0KUclYxiHo-j0g29Kv3D-mF3aE7LNKhj5Lyf4qchy";
        public string DnaHash { get; set; } = "hC0kVlEK-_3ODBfCW7p2uz9RCp_lfqBlJn7eEvJVIeInBJSI5sfR";
