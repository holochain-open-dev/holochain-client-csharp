...
{
    public interface IHoloNETObservableCollection<T> where T : HoloNETEntryBase
    {
        ...
        event HoloNETObservableCollection<T>.Closed OnClosed;
        event HoloNETObservableCollection<T>.CollectionLoaded OnCollectionLoaded;
        event HoloNETObservableCollection<T>.CollectionSaved OnCollectionSaved;
        event HoloNETObservableCollection<T>.Error OnError;
        event HoloNETObservableCollection<T>.HoloNETEntryAddedToCollection OnHoloNETEntryAddedToCollection;
        event HoloNETObservableCollection<T>.HoloNETEntryRemovedFromCollection OnHoloNETEntryRemovedFromCollection;
        event HoloNETObservableCollection<T>.Initialized OnInitialized;
        ...
        HoloNETCollectionLoadedResult<T> LoadCollection(string collectionAnchor = "", bool useReflectionToMapKeyValuePairResponseOntoEntryDataObject = true);
        Task<HoloNETCollectionLoadedResult<T>> LoadCollectionAsync(string collectionAnchor = "", bool useReflectionToMapKeyValuePairResponseOntoEntryDataObject = true);
