                ...
                case TestToRun.AdminAuthorizeSigningCredentials:
                    {
                        ...
                        await _holoNETClient.AdminAuthorizeSigningCredentialsAndGrantZomeCallCapabilityAsync(_holoNETClient.Config.CellId, GrantedFunctionsType.Listed, new List<(string, string)>()
                        {
                            ("zome1", "function1"),
                            ("zome2", "function2")
                        });
