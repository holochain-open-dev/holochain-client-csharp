...
namespace NextGenSoftware.WebSocket
{
    ...
    public class UnityWebSocketException : Exception
    {
        public UnityWebSocketException() { }
        public UnityWebSocketException(string message) : base(message) { }
        public UnityWebSocketException(string message, Exception inner) : base(message, inner) { }
    }
  ...
  public class WebSocket : IWebSocket {
    ...
    public class UnityWebSocket : IWebSocket
    {
        ...
        public UnityWebSocket(string url, string subprotocol, Dictionary<string, string> headers = null)
        {
            uri = new Uri(url);
        ...
        public UnityWebSocket(string url, List<string> subprotocols, Dictionary<string, string> headers = null)
        {
            uri = new Uri(url);
            ...
            get
            {
                switch (m_Socket.State)
                {
                    case System.Net.WebSockets.WebSocketState.Connecting:
                        return WebSocketState2.Connecting;

                    case System.Net.WebSockets.WebSocketState.Open:
                        return WebSocketState2.Open;

                    case System.Net.WebSockets.WebSocketState.CloseSent:
                    case System.Net.WebSockets.WebSocketState.CloseReceived:
                        return WebSocketState2.Closing;

                    case System.Net.WebSockets.WebSocketState.Closed:
                        return WebSocketState2.Closed;
    ...
    public static void DelegateOnCloseEvent (int instanceId, int closeCode) {
      ...
      if (instances.TryGetValue (instanceId, out instanceRef)) {
        ...
        public static UnityWebSocket CreateInstance(string url)
        {
