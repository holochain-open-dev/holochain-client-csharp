...
namespace NextGenSoftware.Holochain.HoloNET.Manager.Managers
{
    public partial class HoloNETManager : IHoloNETManager
    {
        public void InitHoloNETCollection(IHoloNETClientAppAgent client)
        {
            ...
            {
                HoloNETEntriesShared[CurrentApp.Name] = new HoloNETObservableCollection<AvatarShared>("oasis", "get_all_avatars", "add_avatar", "remove_avatar", client, "batch_update_avatars");
